...
public class Mir2ScreenInfoTest {
    ...
    public void testMir2ScreenInfo() throws InterruptedException {
        ...
        System.out.println(mir2Screen.gameScreenLeftTop());
    }

    @Test
    public void testCaptureGameWindow() throws InterruptedException, IOException {
        Mir2Screen mir2Screen = Mir2Screen.getInstance();
        BufferedImage image = mir2Screen.gameScreenImage();
        ImageIO.write(image, "png", new File("C:\\Users\\yang\\Pictures\\game_window.png"));
        Thread.sleep(1000 * 2);
    }

    @Test
    public void testGetSmallMap() throws IOException {
        Mir2Screen mir2Screen = Mir2Screen.getInstance();
        BufferedImage smallMap = mir2Screen.getSmallMap();
        ImageIO.write(smallMap, "png", new File("C:\\Users\\yang\\Pictures\\small_map.png"));
    }
    @Test
