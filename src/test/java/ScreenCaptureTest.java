...
public class ScreenCaptureTest {
    ...
    @Test
    public void getGameWindow() throws IOException {
        Mir2Screen mir2Screen = Mir2Screen.getInstance();
        BufferedImage gameScreen = mir2Screen.gameScreenImage();
        ImageUtil.saveImage(gameScreen, "game_window_max_button");
    }

    @Test
    public void testDnScanAreaCapture() throws IOException {
        Mir2Screen instance = Mir2Screen.getInstance();
