...
public class MapHolder {
	 ...
	 * @return 地图实体
	 */
	public Map readMapFromFile(String mapNo) {
		try{
	...
	public Map changeMapObjectLayerInfo(Integer mapNo){
		try{
			//String mapInfoPath = this.getClass().getResource("/Map/" + String.valueOf(mapNo) + ".gridMap").getPath();
			String mapInfoPath = "C:\\Users\\yang\\Downloads\\Mir2online\\米尔在线\\Map\\0.gridMap";
			FileInputStream fis = new FileInputStream(new File(mapInfoPath));
